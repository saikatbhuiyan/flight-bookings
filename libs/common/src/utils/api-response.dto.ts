...
export class ApiResponseDto<T> {
  ...
  @ApiPropertyOptional({ example: 'Operation successful', description: 'Response message' })
  message?: string;

  @ApiPropertyOptional({ description: 'Error details if success is false' })
  errors?: any[];

  @ApiPropertyOptional({ description: 'Metadata for pagination or other purposes' })
  meta?: any;
