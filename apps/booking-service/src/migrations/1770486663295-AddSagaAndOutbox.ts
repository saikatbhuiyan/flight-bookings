...
export class AddSagaAndOutbox1770486663295 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_3ba29ee0383d442fa0e4f6dbba" ON "saga_states" ("created_at")`,
    );
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_c707d2bbf2290a58023d4f9b16" ON "saga_states" ("status")`);
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_b55caaedced424e15f452ea7bd" ON "saga_states" ("booking_id")`,
    );
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_287c7ad6ab8e2fc1f2e25b59e4" ON "outbox_events" ("event_type")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_85ca65d119cee338ec8d714bfa" ON "outbox_events" ("aggregate_id")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_cc0d2a98103923a41a9aebc384" ON "outbox_events" ("status", "created_at")`,
    );
  }
