...
export class AirportController {
    ...
    @ApiResponse({ status: HttpStatus.CREATED, description: 'Airport created successfully' })
    ...
    @ApiResponse({ status: HttpStatus.OK, description: 'Airports retrieved successfully' })
